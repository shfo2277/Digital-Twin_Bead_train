...
MODEL_SAVE_DIR  = "/home/ho/BEADtrain/modelresult"
MODEL_SAVE_PATH = f"{MODEL_SAVE_DIR}/11272unet.pth"
LOSS_FIG_PATH   = f"{MODEL_SAVE_DIR}/11272unet_loss_curve.png"
...
pos_weight = torch.tensor([3.0], device=device)  # 2~5 사이 튜닝 가능
